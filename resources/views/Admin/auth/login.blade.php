                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form action="{{route('admin.login')}}" method="POST" class="md-float-material" >
                            ...
                            <div class="text-center">
                                <img src="{{asset('backend/assets/images/auth/logo-dark.png')}}" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Your Email Address"  name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
