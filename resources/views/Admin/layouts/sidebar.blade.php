                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    {{-- @if (auth()->user()->photo)
                                    <img class="img-40 img-radius" src="{{auth()->user()->photo}}" alt="User-Profile-Image">
                                    @else
                                    <img class="img-40 img-radius" src="{{asset('backend/assets/images/Default_User.jpg')}}" alt="User-Profile-Image">
                                    @endif --}}
